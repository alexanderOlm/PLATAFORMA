        ...
        <ul>
            ...
            <li>
                <a href="actualizar.php">Actualizar&nbsp;&nbsp;<i class="fas fa-pen-alt"></i></a>
                 <ul class="submenu">
                        <li class="li_sub">
                            <a href="cliente/actualizar.php"> Cliente </a>
                        </li>
                        <li class="li_sub">
                            <a href="Usuarios/actualizar.php">Usuario</a>
                        </li>
                        <li class="li_sub">
                            <a href="Factura/actualizar.php">Factura</a>
                        </li>
                        <li class="li_sub">
                            <a href="producto/actualizar.php">Producto</a>
                        </li>
