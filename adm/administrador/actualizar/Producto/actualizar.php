...
<body>
    <div class="sidebar">
        ...
        <ul>
         ...
         <a href=".././factura/actualizar.php">Actualizar&nbsp;&nbsp;<i class="fas fa-pen-alt"></i></a>
      ...
      <h1>Producto</h1>
        ...
        <div class="conteiner-table4 conteiner-table--edit4">
            ...
            <div class="table__item">
                <a  href="actualizar_campos4.php?id=<?php echo $row["Id_producto"]; ?>" class="table__item__link">Editar</a>
