...
<body>
    <div class="sidebar">
        ...
        <form class="conteiner-table conteiner-table--edit" action="procesar_u.php" method="POST"> 
            ...
            <input type="text" class="table__item" value="<?php echo $row["Usuario"]; ?>" name="Usuario">
            <input type="text" class="table__item" value="<?php echo $row["Clave"]; ?>" name="Clave">
