...
<body>
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li>
                <a href="">Mostrar &nbsp;&nbsp<i class="fas fa-eye"></i></a>
           
           <ul class="submenu">
                        <li class="li_sub">
                            <a href="cliente/cliente.php"> Cliente </a>
                        </li>
                        <li class="li_sub">
                            <a href="Usuarios/Usuarios.php">Usuario</a>
                        </li>
                        <li class="li_sub">
                            <a href="Factura/factura.php">Factura</a>
                        </li>
                        <li class="li_sub">
                            <a href="producto/producto.php">Producto</a>
                        </li>
