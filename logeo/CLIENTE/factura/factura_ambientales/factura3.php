...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../ambientales/Ambiental MR Air Fresh Linen.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Ambiental MR Air Fresh Linen
            </h1>
            <br>
            <h2>
            ...
            <br>
            <h3>
                Costo del producto : $ 2.75 por unidad .
                <br>
                <br>
                Costo por unidad por paquetes : $ 6.75 por unidad.
            </h3>
