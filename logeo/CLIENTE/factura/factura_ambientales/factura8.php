...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../ambientales/Ambiental MR Eclipse Citrus Floral.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Ambiental MR Eclipse Citrus Floral
            </h1>
            <br>
            <h2>
            ...
            <h3>
                ...
                <br>
                <br>
                Costo por unidad por paquetes : $ 15.50 por unidad.
            </h3>
