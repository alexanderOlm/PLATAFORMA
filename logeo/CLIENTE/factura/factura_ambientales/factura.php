...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../ambientales/Ambiental  MR  jelly Belly Very Cherry.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Ambiental MR Jelly Belly Very Cherry
            </h1>
            <br>
            <h2>
            ...
            <br>
            <h3>
                Costo del producto : $ 2.50 por unidad .
                <br>
                <br>
...
function calcular(){
    try{
        var d = 0.12;
        consta =parseFloat(document.getElementById("cantidad").value)  , b =parseFloat(document.getElementById("Precio").value) ;
