...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../ambientales/Ambiental MR Air Citrus Breeze.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Ambiental MR Air Citrus Breeze
            </h1>
            <br>
            <h2>
            ...
            <br>
            <h3>
                Costo del producto : $ 2.00 por unidad .
                <br>
                <br>
                Costo por unidad por paquetes : $ 6.00 por unidad.
            </h3>
