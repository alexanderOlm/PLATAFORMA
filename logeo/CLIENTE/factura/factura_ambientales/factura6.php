...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../ambientales/Ambiental MR Doble Aroma New Car_Clean Cotton.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Ambiental MR Doble Aroma New Car/Clean Cotton
            </h1>
            <br>
            <h2>
