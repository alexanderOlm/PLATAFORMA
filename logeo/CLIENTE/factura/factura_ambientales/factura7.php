...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../ambientales/Ambiental MR Doble Aroma Repuesto.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Ambiental MR Doble Aroma Repuesto
            </h1>
            <br>
            <h2>
            ...
            <br>
            <h3>
                Aroma: New Car-Clean Cotton / Eucalyptus-Lavander
            </h3>
            <br>
            <h3>
                Contenido: 4,5 ml x2
