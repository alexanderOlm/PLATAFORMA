...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../ambientales/Ambiental Chica Fresita 1Pieza.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Ambiental Chica Fresita 1Pieza
            </h1>
            <br>
            <h2>
                Ambiental / Aromatizante
            </h2>
            <br>
            <h3>
                Código: 0040005
            ...
            <br>
            <h3>
                Contiene: 1 unidad / 25 unidades por paquete
            </h3>

            <br>
            <h3>
                Costo del producto : $ 1.50 por unidad .
                <br>
                <br>
                Costo por unidad por paquetes : $ 5.50 por unidad.
            </h3>
