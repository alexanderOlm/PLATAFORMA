...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../Forro_de_volante/Forro de Volante MaxRack LF-CM04.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Forro de Volante MaxRack LF-CM04
            </h1>
            <br>
            <h2>
                Forro de volante
            ...
            <h3>
                ...
                <br>
                <br>
                Costo por unidad por paquetes : $ 12.75 por unidad.
            </h3>
