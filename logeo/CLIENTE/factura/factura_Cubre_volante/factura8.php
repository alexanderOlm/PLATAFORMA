...
<head>
    ...
    <link rel="stylesheet" href="../stilos/for.csss">
...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../Forro_de_volante/MAXRACK14B110.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
               Forro de Volante MaxRack 14B110
            </h1>
            <br>
            <h2>
                Forro de volante
           ...
           <h3>
            ...
            <br>
            <h3>
                Costo del producto : $ 6.00 por unidad .
                <br>
                <br>
