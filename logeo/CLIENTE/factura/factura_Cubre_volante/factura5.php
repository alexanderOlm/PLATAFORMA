...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../Forro_de_volante/Forro de Volante MaxRack LF-CM05.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Forro de Volante MaxRack LF-CM05
            </h1>
            <br>
            <h2>
                Forro de volante
            ...
            <h3>
                ...
                <br>
                <br>
                Costo por unidad por paquetes : $ 20.50 por unidad.
            </h3>
