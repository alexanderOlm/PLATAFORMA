...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../ambientales/Ambiental MR Jelly BellyIsland Punch.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Ambiental MR Jelly Belly Island Punch
            </h1>
            <br>
            <h2>
            ...
            <br>
            <h3>
                Costo del producto : $ 5.00 por unidad .
                <br>
                <br>
                Costo por unidad por paquetes : $ 6.50 por unidad..
            </h3>
    ...
    <form action="insertar.php" method="POST" name="formDatosPersonales"  >
       ...
       <label for="Nombre">Nombre</label>
        ...
        <br>
         ...
         <label for="Precio">ingrese el presio del producto</label>
        <input type="text" name="Precio"  id="val1" name="Precio" onkeyup="sumar()" />
