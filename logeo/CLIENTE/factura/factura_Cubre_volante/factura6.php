...
<body>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../Forro_de_volante/Forro de volante MaxRack LF-CM2.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Forro de volante MaxRack LF-CM2
            </h1>
            <br>
            <h2>
                Forro de volante
            ...
            <h3>
                ...
                <br>
                <br>
                Costo por unidad por paquetes : $ 19.50 por unidad.
            </h3>
