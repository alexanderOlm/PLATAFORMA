...
<body>
    <header>
        <div class="contenedor">
            ...
            <ul class="menu">
                ...
                <li>
                    <a href="../../Cubre_volante/cubre_volante.php">Cubre volantes</a>

                </li>
                <li>
                    <a href="../../Lámin_de_seguridad/Lámina_de_seguridad.php">Lámina de seguridad</a>
    ...
    <section class="factura">
        <div>
            <img class="producto" src="../laminas/Captura.PNG" alt="">
        </div>
        <span class="contenido">
            <h1>
                Lamina de seguridad XSUN
            </h1>
            <br>
            <h2>
                Lámina de seguridad
            ...
            <br>
            <h3>
                Costo del producto : $ 5.50 por unidad .
                <br>
                <br>
                Costo por unidad por paquetes : $ 10.50 por unidad.
            </h3>
